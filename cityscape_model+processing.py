...
class PanopticModel(nn.Module):
    def __init__(self, weight=None, **kwargs):
        ...
        self.model = MonoDVPS(num_classes=len(cityscape_dataloader.classes))
...
def train():
    ...
    log_to_json('I', 'Starting Training. Additional loss: '  + str(USE_ADDITIONAL_DEPTH_LOSS))
    training_data_loader = SemKittiDataset(dir_input="cityscapes-dvps/video_sequence/train", classes=cityscape_dataloader.classes, max_batch_size=32, shuffle=True)
