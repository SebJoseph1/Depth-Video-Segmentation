...
import random
import torch
from cityscape_dataloader import SemKittiDataset, SemKittiClass
...
class PanopticTargetGenerator(object):
    ...
    def create_vip_deeplab_truth(self, current_image):
        ...
        for i in range(len(current_image[0]) - 1):
            ...
            current_image_panoptic_truth = current_image_semantic * 1000 + current_image_instance
            if i == 0:
                ...
                truth_label['panoptic'] = current_image_panoptic_truth.unsqueeze(0).unsqueeze(0)
            else:
                ...
                truth_label['panoptic'] = torch.cat([truth_label['panoptic'],current_image_panoptic_truth.unsqueeze(0).unsqueeze(0)],dim=0)
